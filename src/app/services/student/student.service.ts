...
import { HttpClient } from '@angular/common/http';
 ...
 export class StudentService {
  ...
  getDetails(key){
    return this._http.get('http://localhost:8080/s_details', {
      params: { id: key }
  })
  }
   ...
   addStudent(student:any){
     return this._http.post('http://localhost:8080/insert', student);
   }
   ...
   deleteStudent(key:any){
     return this._http.get('http://localhost:8080/delete', {
      params: { id: key }
  });
   }
